    ...
    return (
        ...
        <section className='w-full bg-bgPrincipal' >
            <div className='flex mx-auto max-w-screen-xl lg:flex-nowrap flex-wrap items-start justify-evenly p-4 sm:p-6'>
                <div className='lg:w-1/2 w-full p-4 sm:py-10 sm:px-4 mt-6 sm:mt-12 max-w-xl sm:max-w-2xl md:max-w-3xl text-left' data-aos="fade-up">
                    ...
                    <button className='mt-4 bg-bgGreen text-white py-4 px-6 rounded' data-aos='fade-up' data-aos-delay='200'>
                        ¡Conócenos!
                    </button>
                </div>
