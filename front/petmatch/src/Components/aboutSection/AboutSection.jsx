...
function AboutSection() {
    ...
    return (
        ...
        <section className='bg-white relative py-24 mx-auto max-w-screen-xl flex justify-center items-center' >
            ...
            <div className='flex md:flex-nowrap flex-wrap w-full items-center justify-center z-10 relative px-6'>
                ...
                <div className='md:w-1/2 w-full p-4 lg:pl-20 md:pl-10 pl-0 max-w-xl sm:max-w-2xl md:max-w-3xl text-left'data-aos="fade-up">
                    {/* <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-bgGreen'> */}
                    <h1 className='text-3xl sm:text-4xl md:text-5xl font-bold text-bgGreen' data-aos="fade-up" data-aos-delay='100'>
                        Acerca De Nosotros
                    </h1>
                    {/* <p className='mt-4 text-base sm:text-lg md:text-xl lg:text-lg text-black font-semibold'> */}
                    <p className='my-4 md:text-lg text-[#444444]' data-aos="fade-up" data-aos-delay='200'>
                ...
                <div className='md:w-1/2 md:pr-8 lg:pr-0 w-4/5 md:pt-0 pt-10' data-aos="fade-up" data-aos-delay='100'>
                    <img
                        src={perrito}
