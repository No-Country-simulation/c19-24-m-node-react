    ...
    return (
        ...
        <section className='bg-white relative py-24 mx-auto max-w-screen-xl flex justify-center items-center'>
            ...
            <div className='flex md:flex-nowrap flex-wrap w-full items-center justify-center z-10 relative px-6'>
                ...
                <div className='md:w-1/2 w-full p-4 lg:pl-20 md:pl-10 pl-0 max-w-xl sm:max-w-2xl md:max-w-3xl text-left'>
                ...
                <div className='md:w-1/2 md:pr-8 lg:pr-0 w-4/5 md:pt-0 pt-10'>
                    <img
                        src={perrito}
